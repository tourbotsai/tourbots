...
import { completeCrmSequenceStep, uncompleteCrmSequenceStep } from '@/lib/services/admin/crm-service';
import { requirePlatformAdmin } from '@/lib/api/require-platform-admin';

export const dynamic = 'force-dynamic';

// Ticking a sequence step complete for a contact is the ONLY way sequence
// activity gets logged. It atomically writes a crm_activities row (the
// single source of truth for what happened) and upserts crm_sequence_step_status
// (which only exists to render the tick state on this page).
