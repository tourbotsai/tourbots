...
export const CUSTOMISATION_CATEGORIES: CustomisationCategory[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      'mobile_thinking_background_color',
      'mobile_thinking_text_color',
      'mobile_user_message_background',
      'mobile_window_background_color',
...
export const FIELD_DESCRIPTIONS = {
  ...
  thinking_background_color: 'Background colour of the "AI is typing" indicator bubble',
  thinking_text_color: 'Text colour of the "AI is typing" indicator label',
  window_background_color: 'Background colour of the chat window body (below the header, above the send bar)',
  ...
  timestamp_color: 'Colour of the message timestamp text',
