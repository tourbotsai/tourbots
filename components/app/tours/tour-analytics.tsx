...
import { Eye, Globe, Calendar, ExternalLink, BarChart3, Users, MessageCircle, Camera, ArrowLeft, ChevronDown, ChevronUp, Monitor, Smartphone, Tablet, Navigation } from 'lucide-react';
import {
  BarChart,
  Bar,
  XAxis,
