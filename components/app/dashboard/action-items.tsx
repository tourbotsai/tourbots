          ...
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-start gap-3 p-4 border rounded-lg">
                <div className="h-8 w-8 bg-gray-200 dark:bg-neutral-800 rounded-full animate-pulse"></div>
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-gray-200 dark:bg-neutral-800 rounded animate-pulse w-3/4"></div>
                  <div className="h-3 bg-gray-200 dark:bg-neutral-800 rounded animate-pulse w-full"></div>
                  <div className="h-6 bg-gray-200 dark:bg-neutral-800 rounded animate-pulse w-20"></div>
                </div>
              </div>
            ))}
          </div>
